...
//object.getClass().isArray()   t(int[]) is .5 isarray is .1 lookup .05
   ...
   * @throws UnsupportedEncodingException  If the named charset is not supported
   */
  public static int numberOfElements(final Object x) throws UnsupportedEncodingException{
    if (x instanceof Dictionary)
      return numberOfElements(((Dictionary)x).keys);
    if (x instanceof Result)
      return numberOfElements(((Result)x).columnValuesArrayOfArray[0]);
  ...
  public int nx(Object x) throws UnsupportedEncodingException{
    ...
    int numBytes=6;
    int numElements= numberOfElements(x);
    if(type==0||type==11)
  ...
  public static Result td(Object tbl) throws UnsupportedEncodingException{
    ...
    int m= numberOfElements(a.columnNames);
    int n= numberOfElements(b.columnNames);
