...
class KrakenPriceSubProcessorTest {
	private KrakenPriceSubProcessor krakenPriceSubProcessor = new KrakenPriceSubProcessor();
	...
	void process_shouldReturnPriceObjectForValidPayload() {
		...
		// Act
		String result = krakenPriceSubProcessor.process(validPayload);
	...
	void process_shouldReturnErrorObjectForMissingPrices() {
		...
		// Act
		String result = krakenPriceSubProcessor.process(invalidPayload);
